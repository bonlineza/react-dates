...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)((0, _object2['default'])({}, _reactWithStyles.withStylesPropTypes, {
  ...
  showBeforeTodayDifferently: _propTypes2['default'].bool,
...
var CalendarDay = function (_React$Component) {
  ...
  function CalendarDay(props) {
    ...
    _this.isBeforeToday = (0, _isBeforeDay2['default'])(props.day, (0, _moment2['default'])());
  ...
  _createClass(CalendarDay, [{
    ...
    value: function () {
      function componentDidUpdate(prevProps) {
        ...
        this.isBeforeToday = (0, _isBeforeDay2['default'])(prevProps.day, (0, _moment2['default'])());
      }
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement(
          'td',
          _extends({}, (0, _reactWithStyles.css)(styles.CalendarDay, useDefaultCursor && styles.CalendarDay__defaultCursor, styles.CalendarDay__default, isOutsideDay && styles.CalendarDay__outside, modifiers.has('today') && styles.CalendarDay__today, modifiers.has('highlighted-calendar') && styles.CalendarDay__highlighted_calendar, modifiers.has('blocked-minimum-nights') && styles.CalendarDay__blocked_minimum_nights, modifiers.has('blocked-calendar') && styles.CalendarDay__blocked_calendar, hoveredSpan && styles.CalendarDay__hovered_span, modifiers.has('selected-span') && styles.CalendarDay__selected_span, modifiers.has('last-in-range') && styles.CalendarDay__last_in_range, modifiers.has('selected-start') && styles.CalendarDay__selected_start, modifiers.has('selected-end') && styles.CalendarDay__selected_end, selected && styles.CalendarDay__selected, isOutsideRange && styles.CalendarDay__blocked_out_of_range, showBeforeTodayDifferently && this.isBeforeToday && styles.CalendarDay__before_today, daySizeStyles), {
